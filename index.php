<!-- My Wordpress Responsive Theme Template 201701:

Uses Bootstrap v3.3.7 (http://getbootstrap.com). As of yet no Sass/Less and Grunt/Gulp.
Contents of bootstrap.css (unminified) have to be viewed through the Bootstrap site.

This a wordpress theme from scratch. See the WordPress tutorial on https://www.taniarascia.com/developing-a-wordpress-theme-from-scratch/ (pdf present in my Web Projects). See also https://codex.wordpress.org/.

This template is based on my temporary basic portfolio site. It minimally needed added blog functionality to make the conversion to WordPress useful. So this theme has an added blog section in comparison with the original temp portfolio site.

Therefore we will have to have index.php calling header.php, footer.php, sidebar.php and content.php. Pages (non-blog entries) wil be auto-generated in content.php, see header.php.
...
The recommended image size is exactly 1200x900 (Jocca: or another size that's close but with the same width-height ratio. Otherwise the screenhot wil not align in the screenshot holder shown at the Details page of the theme). The screenshot will only be shown as 387x290, but the over double-sized image allows for high-resolution viewing on HiDPI displays.

Favicon: Dashboard - Appearance - Customize - Site Identity - Site Icon

The site still needs a few CSS adjustments but the conversion of my temp portf site to a WordPress theme is succesful. Now I can make any html-css combination into a WordPress theme :)
-->
